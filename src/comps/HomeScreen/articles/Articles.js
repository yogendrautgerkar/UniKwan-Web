...
import one from "../../../assets/images/articles/img1.png";
import two from "../../../assets/images/articles/img2.png";
import three from "../../../assets/images/articles/img3.png";
  ...
  constructor(props) {
    ...
    this.state = {
      images: [
        ...
        {
          link: two,
          title: "What is Design- design for problem solving",
        ...
        },
        {
          link: three,
          title:
            "User Research and the benefits of involving users’ at each step",
          subtitle: "YOUR STORY",
          hyLink: "#"
        }
      ]
        ...
        >
          <div className="article_container" key={index} data-index={index}>
            ...
            <div
              className="article"
              style={{
                backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.9), rgba(255, 255, 255, 0)),url(${i.link})`,
                borderRadius: 8
              }}
            >
              <h6 style={{ fontWeight: "500" }}>{limitTitle(i.title, 100)}</h6>
      ...
      <div className="container-fluid my_article_wrapper">
        <section className="container ">
          ...
          <div className="row justify-content-center pt-3 pb-5">
            <div className="col-8">
              Look into our top articles written by our design experts. We have
              been able to cover from the latest design trends to many
              unprecedented topics.
            </div>
          </div>
