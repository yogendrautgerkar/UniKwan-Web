...
import hero from '../../../assets/images/project/innovate_karnataka/hero.jpg'
                     ...
                     <div className="col-12 col-md-6 px-5 px-sm-0">
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <h1 id="project_head">Innovate Karnataka</h1>
                                <p id="project_text">Innovate Karnataka is the key department of the Government of Karnataka - driving innovation to promote a culture of continuous improvement intechnology, to provide economic growth and social impact. </p>
