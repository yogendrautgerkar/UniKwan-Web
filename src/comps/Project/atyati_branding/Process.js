...
import next from '../../../assets/images/project/atyati_branding/next.svg'
import prev from '../../../assets/images/project/atyati_branding/prev.svg'
import work from '../../../assets/images/project/atyati_branding/work.svg'
import sol1 from '../../../assets/images/project/atyati_branding/sol1.jpg'
import sol2 from '../../../assets/images/project/atyati_branding/sol2.jpg'
import bot_banner from '../../../assets/images/project/atyati_branding/bot_banner.jpg'
            ...
            <section className="" id="process_sec"  style={{color:'#6b6b6b '}}>
                ...
                <div className=" row justify-content-center align-items-center process-space pt-5 pb-5 px-5" id="project_text_sec">
                    <div className="col-lg-7 col-md-7 col-sm-12 text-center ">
                        ...
                        <p>Since atyati is a mature company and has been around from the time when digital platforms were not very active. The old logo of atyati did not have much recognition despite its vast coverage of 31,000 villages with around 30,000, 000 customers all over the country. Re-branding of atyati was essential for business success: to evolve the brand so as to make sure that it keeps abreast of the competition and meet the consumers ever changing preferences.</p>
                    </div>
                </div>
...
<div className=" row justify-content-center align-items-center process-space pt-5 pb-5" id="project_text_sec">
                    <div className="col-lg-7 col-md-7 col-sm-12 text-center ">
                        ...
                        <p>The new brand logo was launched on the 10th annual day of the company with a lot of energy and enthusiasm which complimented the reason behind the rebranding. The logo was happily welcomed by all the stakeholders of atyati.</p>
                    </div>
                </div>
