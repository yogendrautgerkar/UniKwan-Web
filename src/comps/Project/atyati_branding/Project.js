...
import hero from '../../../assets/images/project/atyati_branding/hero.jpg'
                     ...
                     <div className="col-12 col-md-6 px-5 px-sm-0">
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <h1 id="project_head">Atyati Branding</h1>
                                <p id="project_text">atyati technologies allows companies to provide financial services for the last mile, through its technology & services platform. Their vision is solving the challenge of reaching the unreached with their technology and distribution expertise in a transparent, efficient and an effective manner.</p>

                                <div className="project_details">
                                    <div>
                                        <p id="details_head">Clients</p>
                                        <p id="details_item">K-Tech</p>
                                    </div>
                                    <div>
