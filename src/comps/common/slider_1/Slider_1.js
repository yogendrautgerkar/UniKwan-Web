...
import ik from "../../../assets/images/slider/ik_bi.jpg";
import atyati from "../../../assets/images/slider/atyati_bi.jpg";
      ...
      images: [
        {
          link: ik,
          title: "K-Tech",
          hyLink: "/project/ktech"
        },
        {
          link: atyati,
          title: "Atyati",
          hyLink: "/project/atyati_web"
        }
      ]
    };
  }
  ...
  render() {
    ...
    return (
      <div style={{ height: "100%" }} id="home_auto_slider">
        ...
        {/* <span id="slider_proj_title">Innovate Karnataka</span> */}
      </div>
    );
  }
}
    ...
    >
      <ReactSVG
        ...
        afterInjection={(e, svg) => {
          ...
          svg.setAttribute(
            "style",
            "position:absolute;bottom:10px; line-height:1"
          );
