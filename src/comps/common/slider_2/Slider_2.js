...
import di from '../../../assets/images/slider/di_cx.jpg'
import atyati from '../../../assets/images/slider/atyati_cx.jpg'
import lm from '../../../assets/images/slider/lm_cx.jpg'
            ...
            images:[
              {
                link: di,
                title: 'Dialog TV',
                hyLink: '/project/dialog',
              },{
                link: atyati,
                title: 'Atyati',
                hyLink: '/project/aayaam',
              },
              {
                link: lm,
                title: 'Light Metrics',
                hyLink: '/project/lightmetrics',
              }
             ]
        }
    }
...
const SampleNextArrow=(props)=> {
  ...
  return (
    ...
    ><ReactSVG id="slider_btn" src ={next} afterInjection={(e,svg)=>{
     ...
     svg.setAttribute('style','position:absolute;bottom:10px; line-height:1')
